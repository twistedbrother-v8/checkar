          ...
          <div style={{ position: "relative", background: "#1a1a1a", borderRadius: 20, padding: 24, width: "100%", maxWidth: 380, border: "1px solid rgba(255,255,255,0.1)", overflow: "hidden" }}>
            ...
            <div style={{ background: "#2a2a2f", borderRadius: 12, padding: 14, marginBottom: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <button onClick={() => { if (lang !== "fr") { if (isPremium) toggleLang(); else setShowPremium(true); } }} style={{ flex: 1, background: "linear-gradient(90deg, #002395 33.3%, #ffffff 33.3%, #ffffff 66.6%, #ED2939 66.6%)", border: `3px solid ${lang === "fr" ? "#fff" : "transparent"}`, borderRadius: 12, padding: "18px 0", cursor: "pointer", fontSize: 0, lineHeight: 1, transition: "all 0.2s", opacity: lang === "fr" ? 1 : 0.45, boxShadow: lang === "fr" ? "0 0 0 2px #ffffff88, 0 4px 20px rgba(0,35,149,0.6)" : "none" }}>
                </button>
